...
[`tryanneal_detectors/corpus/patterns.json`](./tryanneal_detectors/corpus/patterns.json) ships **113 vetted entries spanning $10.1B in real historical losses across 13 chains and 2020-2026**. The file is generated by [`build_corpus.py`](./tryanneal_detectors/corpus/build_corpus.py) from raw research dumps in [`tryanneal_detectors/corpus/research/`](./tryanneal_detectors/corpus/research/) (see the [research README](./tryanneal_detectors/corpus/research/README.md) for the discovery overview).
